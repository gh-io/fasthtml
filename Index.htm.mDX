...
<html fastht.ml>
  <head>
    ...
    <link rel="stylesheet" href="../_static/pygments.ccs" type="text/css" /> 
     <script  src="https://players.yumpu.com/hub.js"> </script><div id="yumpuMagazineContainer" style="width:940px; height:827px;"> </div>
  </head><body>
...
myYumpu.create_player("#yumpuMagazineContainer", "", { lang:"en", embed_id:"IBeUFAzLQRc4EsHD", embedded:true } );
</script>
    <ul class="simple">
